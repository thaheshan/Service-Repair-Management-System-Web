          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div className="flex flex-col">
               <div className="flex items-center gap-3">
                 <h1 className="text-[32px] font-black text-[#0F172A] tracking-tight">{customerName}</h1>
                 <span className={`px-3 py-1 rounded-full text-[12px] font-bold border shadow-sm ${
                   customerTier === 'VIP' ? 'bg-amber-50 text-amber-700 border-amber-200' :
               ...
               <p className="text-[14px] text-muted-foreground font-medium flex items-center gap-2">
                 Customer ID: <span className="text-[#0F172A] font-bold">{id.slice(-8).toUpperCase()}</span>
               ...
               <div className="flex flex-col gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start justify-between group">
                         <div className="flex items-start gap-3">
                           ...
                           <div className="flex flex-col">
                             <span className="text-[14px] font-medium text-[#0F172A]">{customerAddress}</span>
                 ...
                 <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-border p-5 flex flex-col">
                      ...
                      <span className="text-[24px] font-black text-[#0F172A] leading-none mb-1">{customer?.repairs?.length || 0}</span>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-border p-5 flex flex-col">
                      <div className="h-10 w-10 rounded-lg bg-[#ECFDF5] flex items-center justify-center mb-3">
                       ...
                       <span className="text-[24px] font-black text-[#0F172A] leading-none mb-1">Rs. {spentRaw.toLocaleString()}</span>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-border p-5 flex flex-col">
                       ...
                       <span className="text-[24px] font-black text-[#0F172A] leading-none mb-1">{lastVisitLabel}</span>
                          ...
                          <div key={repair.id} className="relative flex items-start gap-4">
                            ...
                            <div className="flex flex-col flex-1">
                              <div className="flex items-center justify-between">
                                <span className="text-[13px] font-bold text-[#0F172A]">Repair {repair.status}</span>
                        ...
                        customerNotes.map((note: any) => {
                          ...
                          return (
                            <div key={note.id} className="flex gap-4">
                              <img src={`https://ui-avatars.com/api/?name=${authorName}&background=random`} alt={authorName} className="h-8 w-8 shrink-0 rounded-full border border-border object-cover" />
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  <span className="text-[12px] font-bold text-[#0F172A]">{authorName}</span>
               ...
               <div className="flex flex-col gap-6">
                 ...
                 <div className="bg-white rounded-xl shadow-sm border border-border p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <button onClick={() => setIsScheduleModalOpen(true)} className="flex flex-col items-center justify-center gap-2 h-[72px] rounded-lg border border-border bg-white text-muted-foreground hover:bg-muted hover:text-[#4F46E5] hover:border-[#4F46E5]/30 transition-all focus:outline-none shadow-sm group">
                 ...
                 <div className="bg-white rounded-xl shadow-sm border border-border p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                       ...
                       {customer?.tags?.filter((t: string) => t !== customerTier).map((tag: string) => (
                         <span key={tag} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#F8FAFC] text-[#0F172A] text-[11px] font-bold border border-border group">
                 ...
                 <div className="bg-white rounded-xl shadow-sm border border-border p-6">
                    ...
                    <div className="flex justify-between items-center text-[11px] font-bold text-[#0F172A] mb-1.5">
                       ...
                       <span className="text-[#0F172A]">{(customer?.pointsToNextTier || 100)} points away</span>
                    </div>
                    ...
                    <div className="space-y-4 text-[12px] font-medium text-[#0F172A]">
                      ...
                      <div className="pb-1">
                         <span className="block text-muted-foreground mb-3">Notifications</span>
                          <div className="space-y-4">
                           <div className="flex items-center justify-between group">
                             <span className="text-[13px] text-[#334155]">Email Notifications</span>
                             <button 
                             ...
                             >
                               {customer?.preferences?.notifications?.email ? (
                                 ...
                                 <div className="h-5 w-5 rounded-[2px] border border-border bg-white" />
                               )}
                             </button>
                           </div>
                           <div className="flex items-center justify-between group">
                             <span className="text-[13px] text-[#334155]">SMS Notifications</span>
                             <button 
                           ...
                           <div className="flex items-center justify-between group">
                             <span className="text-[13px] text-[#334155]">Push Notifications</span>
                             <button 
          ...
          {activeTab === "repairs" && (
            <div className="bg-white rounded-xl shadow-sm border border-border overflow-hidden">
               <table className="w-full text-left">
                 <thead>
                   <tr className="bg-[#F8FAFC] border-b border-border text-[11px] font-bold text-muted-foreground uppercase tracking-widest">
                 ...
                 <tbody className="divide-y divide-border/60">
                   {customer?.repairs?.length === 0 ? (
                     ...
                     customer?.repairs?.map((repair: any) => (
                       <tr key={repair.id} className="hover:bg-[#F8FAFC]/50 transition-colors">
                         <td className="px-6 py-4 text-[13px] font-black text-[#4F46E5]">#{repair.repairNumber || repair.id.slice(-6).toUpperCase()}</td>
                         <td className="px-6 py-4">
                           <div className="flex flex-col">
                             <span className="text-[13px] font-bold text-[#0F172A]">{repair.model}</span>
                         ...
                         <td className="px-6 py-4 text-right text-[13px] font-black text-[#0F172A]">Rs. {(repair.totalPrice || 0).toLocaleString()}</td>
                         <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              <Link 
                                href={`/admin/repairs/${repair.id.trim()}`}
                                className="h-8 w-8 rounded-lg border border-border bg-white flex items-center justify-center text-muted-foreground hover:text-[#4F46E5] hover:border-[#4F46E5]/30 transition-all focus:outline-none"
                              >
          ...
          {activeTab === "devices" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {customer?.devices?.length === 0 ? (
                <div className="col-span-full bg-white rounded-xl shadow-sm border border-border p-12 text-center">
                  <p className="text-muted-foreground italic">No devices registered for this customer.</p>
                </div>
              ) : (
                customer?.devices?.map((device: any) => (
                  <div key={device.id} className="bg-white rounded-xl shadow-sm border border-border p-5 hover:border-[#4F46E5]/30 transition-all group">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="h-12 w-12 rounded-xl bg-[#EEF2FF] flex items-center justify-center text-[#4F46E5] group-hover:scale-110 transition-transform">
                        <Wrench className="h-6 w-6" />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[14px] font-black text-[#0F172A]">{device.model || device.name}</span>
                        <span className="text-[11px] font-bold text-[#4F46E5]">{device.brand}</span>
                      </div>
                    </div>
                    <div className="space-y-2 border-t border-border/50 pt-4">
                      <div className="flex justify-between text-[11px]"><span className="text-muted-foreground">IMEI/Serial</span><span className="font-bold text-[#0F172A]">{device.serialNumber || 'N/A'}</span></div>
                      ...
                      <div className="flex items-center gap-2 mt-4 pt-3 border-t border-border/30">
                        <Link 
                          ...
                          className="flex-1 h-8 rounded-lg border border-border bg-white flex items-center justify-center gap-2 text-[11px] font-bold text-muted-foreground hover:text-[#4F46E5] hover:border-[#4F46E5]/30 transition-all focus:outline-none"
                        >
                        ...
                        <button 
                          ...
                          className="w-10 h-8 rounded-lg border border-border bg-white flex items-center justify-center text-muted-foreground hover:text-[#4F46E5] hover:border-[#4F46E5]/30 transition-all focus:outline-none"
                        >
           ...
           <div className="bg-white w-full max-w-[440px] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-red-100">
              <div className="flex flex-col items-center justify-center p-8 pb-6 text-center">
                 ...
                 <p className="text-[14px] text-muted-foreground leading-relaxed mt-4">
                   Are you sure you want to completely erase the record for <span className="font-bold text-[#0F172A]">{customerName}</span>? This action is permanent and will orphan {customer?.repairs?.length || 0} historical repair records.
                 </p>
              </div>
              <div className="px-8 pb-8 flex flex-col gap-4">
                   <div className="mb-4">
                     ...
                     <input 
                       ...
                       className="w-full h-11 rounded-lg border border-red-200 bg-red-50/50 px-4 text-[14px] font-black tracking-widest text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 text-center uppercase" 
                     />
                   </div>
           ...
           <div className="bg-white w-full max-w-[500px] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
              ...
              <div className="p-6">
                 <p className="text-[13px] text-muted-foreground mb-6">
                   Select the destination profile. All repair histories, devices, and communications from <span className="font-bold text-[#0F172A]">{customerName}</span> will be migrated over.
                 </p>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="relative">
                      <input 
                        ...
                        className="w-full h-11 pl-4 pr-10 rounded-xl border border-border bg-white text-[13px] focus:outline-none focus:ring-2 focus:ring-[#4F46E5]/20 focus:border-[#4F46E5]" 
                      />
                      <Search className="absolute right-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    </div>
                    
                    {searchResults.length > 0 && (
                      <div className="mt-2 max-h-48 overflow-y-auto border border-border rounded-xl bg-white shadow-sm divide-y divide-border">
                        {searchResults.map((res: any) => (
                          <button 
                            ...
                            className={`w-full p-3 text-left hover:bg-muted transition-colors flex flex-col ${selectedTargetId === res.id ? 'bg-[#EEF2FF]' : ''}`}
                          >
                            <span className="text-[13px] font-bold text-[#0F172A]">{res.name}</span>
                    ...
                    <div className="mt-3 p-4 border border-border rounded-xl bg-[#F8FAFC]">
                       ...
                       {selectedTarget ? (
                         <div className="flex flex-col gap-1">
                           <p className="text-[14px] font-black text-[#0F172A]">{selectedTarget.name}</p>
                           <p className="text-[12px] text-muted-foreground">{selectedTarget.email} • {selectedTarget.phone}</p>
                           <div className="flex items-center gap-2 mt-2">
                             <span className="px-2 py-0.5 rounded-full bg-[#EEF2FF] text-[#4F46E5] text-[10px] font-bold border border-[#4F46E5]/20">Destination Profile</span>
                           </div>
                         </div>
                       ) : (
                  ...
                  <div className="flex w-full gap-3">
                     <button onClick={() => {
                       ...
                       setMergeSearch("")
                     }} className="flex-1 h-11 rounded-xl border border-border bg-white text-[#0F172A] font-bold hover:bg-muted transition-colors focus:outline-none">
                       Cancel
                     </button>
                     <button 
           ...
           <div className="bg-white w-full max-w-[500px] rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
              <div className="flex items-center justify-between p-6 border-b border-border bg-[#F8FAFC]">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-[18px] font-black text-[#0F172A] leading-tight">Schedule Appointment</h2>
                      <p className="text-[12px] font-bold text-[#4F46E5]">Planning with {customerName}</p>
                    </div>
                 </div>
                  <button onClick={() => setIsScheduleModalOpen(false)} className="h-8 w-8 rounded-full flex items-center justify-center text-muted-foreground hover:bg-muted hover:text-[#0F172A] transition-colors focus:outline-none">
                    <X className="h-5 w-5" />
                  </button>
              </div>
              ...
              <div className="p-8 space-y-6">
                {/* 1. Type Selection */}
                <div>
                  <label className="block text-[12px] font-bold text-[#0F172A] mb-3 uppercase tracking-wider">Appointment Type</label>
                  <div className="grid grid-cols-2 gap-4">
                    <button 
                      onClick={() => setScheduleForm(p => ({...p, type: 'Call'}))}
                      className={`flex items-center justify-center gap-3 h-12 rounded-xl border font-bold text-[13px] transition-all ${scheduleForm.type === 'Call' ? 'bg-[#EEF2FF] border-[#4F46E5] text-[#4F46E5] shadow-sm' : 'bg-white border-border text-muted-foreground hover:bg-muted'}`}
                    >
                      <PhoneCall className="h-4 w-4" /> Call
                    </button>
                    <button 
                      onClick={() => setScheduleForm(p => ({...p, type: 'Meeting'}))}
                      className={`flex items-center justify-center gap-3 h-12 rounded-xl border font-bold text-[13px] transition-all ${scheduleForm.type === 'Meeting' ? 'bg-[#EEF2FF] border-[#4F46E5] text-[#4F46E5] shadow-sm' : 'bg-white border-border text-muted-foreground hover:bg-muted'}`}
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[12px] font-bold text-[#0F172A] mb-2 uppercase tracking-wider">Date</label>
                    <div className="relative">
                      <input 
                        type="date"
                        value={scheduleForm.date}
                        onChange={(e) => setScheduleForm(p => ({...p, date: e.target.value}))}
                        className="w-full h-11 px-4 rounded-xl border border-border text-[13px] focus:outline-none focus:ring-2 focus:ring-[#4F46E5]/20 focus:border-[#4F46E5]"
                      />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[12px] font-bold text-[#0F172A] mb-2 uppercase tracking-wider">Time</label>
                    <div className="relative">
                      <input 
                        type="time"
                ...
                {/* 3. Notes */}
                <div>
                  <label className="block text-[12px] font-bold text-[#0F172A] mb-2 uppercase tracking-wider">Internal Notes</label>
                  <textarea 
                    rows={3}
