  ...
  return (
    <div className="flex bg-[#F8FAFC] text-foreground min-h-screen">
      ...
      <main className="flex-1 ml-[200px] flex flex-col">
        ...
        <div className="w-full max-w-[1280px] px-8 py-8 mx-auto flex flex-col min-h-full">
          ...
          <div className="flex items-center gap-1.5 text-[13px] text-muted-foreground font-semibold mb-4">
            ...
            {/* Note: The UI image breadcrumb literally says 'Staff Management' for this page too, presumably a design typo, but let's stick to true structure */}
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 h-10 px-4 rounded-lg border border-border bg-white text-[13px] font-bold text-[#0F172A] hover:bg-muted shadow-sm transition-colors focus:outline-none">
                <UserPlus className="h-4 w-4 text-muted-foreground" /> Manage Roles
              </button>
              <button className="flex items-center gap-2 h-10 px-5 rounded-lg bg-[#4F46E5] text-[13px] font-bold text-white shadow-sm hover:bg-[#4338CA] transition-colors focus:outline-none">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 relative">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto flex-1">
              ...
              <button className="flex items-center justify-between gap-2 w-32 h-10 px-4 rounded-lg border border-border bg-white text-[13px] font-semibold text-[#0F172A] hover:bg-muted shadow-sm transition-colors focus:outline-none md:ml-auto">
              ...
              <button className="flex items-center justify-between gap-2 max-w-44 h-10 px-4 rounded-lg border border-border bg-white text-[13px] font-semibold text-[#0F172A] hover:bg-muted shadow-sm transition-colors focus:outline-none">
              ...
              {isFiltersOpen && (
                <div className="absolute right-0 top-14 w-[340px] bg-white rounded-xl shadow-2xl border border-border/80 p-6 z-50 animate-in fade-in slide-in-from-top-4 duration-200">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="text-[12px] font-bold text-[#4F46E5] hover:underline focus:outline-none">Clear All</button>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-2.5">
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="h-[15px] w-[15px] rounded border-border text-[#4F46E5] focus:ring-[#4F46E5]" />
                      ...
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" defaultChecked className="h-[15px] w-[15px] rounded border-border text-[#4F46E5] focus:ring-[#4F46E5]" />
                  ...
                  <div className="mb-6 space-y-5">
                    <div>
                       <label className="block text-[12px] font-bold text-[#0F172A] mb-2">Total Repairs</label>
                       <div className="h-1.5 w-full bg-[#E2E8F0] rounded-full relative mb-1.5">
                         <div className="absolute left-[20%] right-[40%] h-full bg-[#4F46E5] rounded-full"></div>
                         <div className="absolute left-[20%] top-1/2 -translate-y-1/2 h-3.5 w-3.5 bg-white border-2 border-[#4F46E5] rounded-full shadow-sm cursor-grab"></div>
                         <div className="absolute right-[40%] top-1/2 -translate-y-1/2 h-3.5 w-3.5 bg-white border-2 border-[#4F46E5] rounded-full shadow-sm cursor-grab"></div>
                       </div>
                    ...
                    <div>
                       <label className="block text-[12px] font-bold text-[#0F172A] mb-2">Total Spent</label>
                       <div className="h-1.5 w-full bg-[#E2E8F0] rounded-full relative mb-1.5">
                         <div className="absolute left-[15%] right-[60%] h-full bg-[#4F46E5] rounded-full"></div>
                         <div className="absolute left-[15%] top-1/2 -translate-y-1/2 h-3.5 w-3.5 bg-white border-2 border-[#4F46E5] rounded-full shadow-sm cursor-grab"></div>
                         <div className="absolute right-[60%] top-1/2 -translate-y-1/2 h-3.5 w-3.5 bg-white border-2 border-[#4F46E5] rounded-full shadow-sm cursor-grab"></div>
                       </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <button className="h-10 w-full bg-[#4F46E5] rounded-lg text-white text-[13px] font-bold shadow-md hover:bg-[#4338CA] transition-colors focus:outline-none">
                      Apply Filters
                    </button>
                    <button onClick={() => setIsFiltersOpen(false)} className="h-9 w-full rounded-lg text-red-500 text-[13px] font-bold hover:bg-red-50 transition-colors focus:outline-none">
                      Reset All
                    </button>
                  </div>
                </div>
            ...
            {customersMock.map((customer) => (
              <div key={customer.id} className="bg-white rounded-[16px] border border-border p-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] hover:border-[#4F46E5]/30 hover:shadow-md transition-all group flex flex-col items-center text-center">
                 ...
                 <div className="flex items-center justify-center gap-3">
                   <button className="h-8 w-10 flex flex-col items-center justify-center rounded-lg border border-border bg-white text-muted-foreground hover:text-[#4F46E5] hover:border-[#4F46E5]/30 hover:bg-[#EEF2FF] transition-all focus:outline-none">
